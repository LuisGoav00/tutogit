...
<h2>Agregar productos</h2>
    <form  action ="modificar.php" method = "get" enctype = "multipart/form-data" onsubmit = "return validar();">
        <div class="form-group">
        <label for="id-prod">ID:</label><input type="text" name="id" value="<?=$_GET['id']?>" readonly>
        <br>
        <label>Nombre:</label>
        <input type="text" name="nombre" id="nombre" onblur="verificarNombre(this)" placeholder="nombre" value="<?=$_GET['nombre']?>">
           <br>
           <label> Marca:</label>
           <select type="text" name ="marca" id = "marca"  placeholder="Marca" value="<?=$_GET['marca']?>">
           ...
           <br>
            <label> Modelo:</label>
            <input type="text" name = "modelo" id = "modelo" onblur="verificarModelo(this)" placeholder="Modelo" value="<?=$_GET['modelo']?>">
            <br>
            <label> Precio:</label> 
            ...
            <input type="text" name ="unidades" id = "unidades" onblur = "verificarUnidades(this)" placeholder="Numero de unidades" value="<?=$_GET['unidades']?>">
            <br>
            <label>Imagen:</label>
